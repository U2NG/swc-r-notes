...
* The warning is telling us that we unsuccessfully added ‘tortoiseshell’ to our coat factor, but 3.3 (a numeric), TRUE (a logical), and 9 (a numeric) were successfully added to weight, likes_string, and age, respectively, since those values are not factors. 
* To successfully add a cat with a ‘tortoiseshell’ coat, explicitly add ‘tortoiseshell’ as a level in the factor:
